...
(function($) {
  ...
  $(function () {
    ...
    $(window).bind('resize.ding_event_grouping', function (evt) {
      if (culture.breakpoint.is('mobile', 'mobile_out_reset') === culture.breakpoint.OUT) {
        culture.breakpoint.reset('event_grouping');
      }

      switch (culture.breakpoint.is('tablet', 'event_grouping')) {
        case culture.breakpoint.IN:
          if (culture.breakpoint.is('mobile') === culture.breakpoint.OUT) {
      ...
      switch (culture.breakpoint.is('mobile', 'event_grouping_mobile')) {
        case culture.breakpoint.IN:
          if (masonry_is_active === true) {
            $('.view-ding-event.max-two-rows .view-elements').masonry('destroy');
          }
  ...
  function handle_ding_event_masonry(force) {
    if (force === true) {
      culture.breakpoint.reset('event_masonry');
    }

    switch (culture.breakpoint.is('mobile', 'event_masonry')) {
      case culture.breakpoint.IN:
  ...
  $(function () {
    ...
    $(window).bind('resize.ding_view_slide', function (evt) {
      switch (culture.breakpoint.is('mobile', 'view_slide')) {
        case culture.breakpoint.IN:
